...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Period-2018-2026%20%7C%2054881%20obs-4caf50?style=for-the-badge&labelColor=4a4f59" alt="Period">
...
本次前复权数据运行覆盖 2018-01-02 至 2026-09-01，配置中共有 30 只场内基金，各标的按可用历史进入，合计 54881 条日频记录。
...
|:---|---:|---:|---:|---:|---:|
| 全配置资产等权参照 | 8.58% | 12.56% | 0.74 | -15.95% | 2.041 |
| 复合拥挤度得分对照 | 13.54% | 14.43% | 0.99 | -15.82% | 3.005 |
| 沪深300 ETF 买入持有 | 3.32% | 19.62% | 0.27 | -42.16% | 1.327 |
| 凸优化动量 - 拥挤度 | 14.17% | 12.11% | 1.20 | -11.54% | 3.153 |
| 凸优化动量 - 拥挤度 + 趋势过滤 | 9.58% | 10.81% | 0.93 | -13.12% | 2.209 |
| 动量 - 拥挤度 top30 上限等权 | 10.39% | 14.39% | 0.79 | -16.08% | 2.355 |
| 动量 - 拥挤度 top30 上限等权 + 趋势过滤 | 7.90% | 12.77% | 0.68 | -19.23% | 1.932 |
| 5 日动量对照 | 6.13% | 15.00% | 0.49 | -18.36% | 1.674 |
...
- 主实验「凸优化动量 - 拥挤度」在全样本记录年化 14.17%、标准 Sharpe 1.20、最大回撤 -11.54%，周均 L1 换手为 0.404。
- 在相同信号定义下，旧 top30% 上限等权配置的 Sharpe 为 0.79、最大回撤为 -16.08%；凸优化配置对应 1.20 和 -11.54%。两种配置的资产纳入、持仓上限和实际总暴露均有差异，因此这里只报告观察到的比较。
- 以 2023-01-01 为界进行时间切分，较早区间 Sharpe 为 1.13，较晚区间为 1.29。这个结果用于检查时间稳定性，不代表完全未观察的样本外检验。
...
|---:|:---|---:|---:|---:|---:|---:|
| 0 bps | 情景 | 14.88% | 12.11% | 1.250 | -11.36% | 3.326 |
| 1 bps | 情景 | 14.65% | 12.11% | 1.233 | -11.42% | 3.267 |
| 2 bps | 情景 | 14.41% | 12.11% | 1.215 | -11.48% | 3.210 |
| 3 bps | 基准 | 14.17% | 12.11% | 1.198 | -11.54% | 3.153 |
| 5 bps | 情景 | 13.70% | 12.10% | 1.163 | -11.67% | 3.042 |
| 10 bps | 情景 | 12.54% | 12.10% | 1.075 | -11.98% | 2.782 |
...
The latest forward-adjusted run covers 2018-01-02 to 2026-09-01 and contains 54881 daily observations across 30 configured listed funds over their available histories.
...
|:---|---:|---:|---:|---:|---:|
| Configured-Universe EW Reference | 8.58% | 12.56% | 0.74 | -15.95% | 2.041 |
| Composite Crowding-Score Control | 13.54% | 14.43% | 0.99 | -15.82% | 3.005 |
| CSI 300 Buy & Hold | 3.32% | 19.62% | 0.27 | -42.16% | 1.327 |
| Convex Mom-Crowding | 14.17% | 12.11% | 1.20 | -11.54% | 3.153 |
| Convex Mom-Crowding + Trend | 9.58% | 10.81% | 0.93 | -13.12% | 2.209 |
| Capped Top-30% Mom-Crowding | 10.39% | 14.39% | 0.79 | -16.08% | 2.355 |
| Capped Top-30% Mom-Crowding + Trend | 7.90% | 12.77% | 0.68 | -19.23% | 1.932 |
| 5D Momentum Control | 6.13% | 15.00% | 0.49 | -18.36% | 1.674 |
...
- The main Convex Mom-Crowding experiment records 14.17% annualized return, a standard Sharpe of 1.20, -11.54% max drawdown, and 0.404 average weekly L1 turnover over the full sample.
- Under the same signal definition, the legacy capped top-30% configuration records Sharpe of 0.79 and max drawdown of -16.08%; the convex configuration records 1.20 and -11.54%. Eligible assets, position caps, and resulting exposure also differ, so the comparison does not isolate a causal effect.
- A 2023-01-01 temporal split reports Sharpe of 1.13 in the earlier segment and 1.29 in the later segment. This stability diagnostic does not establish a fully untouched out-of-sample test.
