...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Period-2018-2026%20%7C%2055361%20obs-4caf50?style=for-the-badge&labelColor=4a4f59" alt="Period">
...
本次前复权数据运行覆盖 2018-01-02 至 2026-09-23，配置中共有 30 只场内基金，各标的按可用历史进入，合计 55361 条日频记录。
...
|:---|---:|---:|---:|---:|---:|
| 全配置资产等权参照 | 8.37% | 12.55% | 0.73 | -15.95% | 2.016 |
| 复合拥挤度得分对照 | 13.20% | 14.40% | 0.96 | -15.82% | 2.948 |
| 沪深300 ETF 买入持有 | 3.05% | 19.57% | 0.26 | -42.16% | 1.300 |
| 凸优化动量 - 拥挤度 | 13.71% | 12.09% | 1.16 | -11.54% | 3.066 |
| 凸优化动量 - 拥挤度 + 趋势过滤 | 9.41% | 10.78% | 0.92 | -13.12% | 2.190 |
| 动量 - 拥挤度 top30 上限等权 | 10.06% | 14.36% | 0.76 | -17.83% | 2.308 |
| 动量 - 拥挤度 top30 上限等权 + 趋势过滤 | 7.76% | 12.73% | 0.67 | -19.23% | 1.919 |
| 5 日动量对照 | 5.97% | 14.97% | 0.48 | -20.04% | 1.658 |
...
|---:|:---|---:|---:|---:|---:|---:|
| 0 bps | 情景 | 14.41% | 12.10% | 1.215 | -11.36% | 3.237 |
| 1 bps | 情景 | 14.18% | 12.10% | 1.198 | -11.42% | 3.179 |
| 2 bps | 情景 | 13.94% | 12.10% | 1.180 | -11.48% | 3.122 |
| 3 bps | 基准 | 13.71% | 12.09% | 1.163 | -11.54% | 3.066 |
| 5 bps | 情景 | 13.24% | 12.09% | 1.127 | -11.67% | 2.958 |
| 10 bps | 情景 | 12.07% | 12.08% | 1.039 | -11.98% | 2.702 |
...
The latest forward-adjusted run covers 2018-01-02 to 2026-09-23 and contains 55361 daily observations across 30 configured listed funds over their available histories.
...
|:---|---:|---:|---:|---:|---:|
| Configured-Universe EW Reference | 8.37% | 12.55% | 0.73 | -15.95% | 2.016 |
| Composite Crowding-Score Control | 13.20% | 14.40% | 0.96 | -15.82% | 2.948 |
| CSI 300 Buy & Hold | 3.05% | 19.57% | 0.26 | -42.16% | 1.300 |
| Convex Mom-Crowding | 13.71% | 12.09% | 1.16 | -11.54% | 3.066 |
| Convex Mom-Crowding + Trend | 9.41% | 10.78% | 0.92 | -13.12% | 2.190 |
| Capped Top-30% Mom-Crowding | 10.06% | 14.36% | 0.76 | -17.83% | 2.308 |
| Capped Top-30% Mom-Crowding + Trend | 7.76% | 12.73% | 0.67 | -19.23% | 1.919 |
| 5D Momentum Control | 5.97% | 14.97% | 0.48 | -20.04% | 1.658 |
