...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Period-2018%E2%80%932026%20%C2%B7%2054671%20obs-4caf50?style=for-the-badge&labelColor=4a4f59" alt="Period">
...
本次真实数据运行覆盖 2018-01-02 至 2026-08-21，共 30 只 ETF，合计 54671 条日频记录，数据由 Tushare 成功下载。
...
|:--|--:|--:|--:|--:|--:|
| 全 ETF 等权 | 11.16% | 16.51% | 0.68 | -18.83% | 2.492 |
| 纯拥挤度 top30 对照组 | 22.08% | 34.31% | 0.64 | -17.38% | 5.597 |
| 沪深300 ETF 买入持有 | 1.44% | 19.69% | 0.07 | -45.10% | 1.132 |
| 动量 - 拥挤度惩罚 | 12.12% | 16.41% | 0.74 | -19.42% | 2.684 |
| 动量 - 拥挤度惩罚 + 趋势过滤 | 9.16% | 12.77% | 0.72 | -18.77% | 2.131 |
| 纯 5 日动量 top30 | 8.13% | 16.91% | 0.48 | -20.81% | 1.963 |
...
The latest real-data run covers 2018-01-02 to 2026-08-21, with 30 ETFs, 54671 daily observations downloaded from Tushare.
...
|:--|--:|--:|--:|--:|--:|
| All-ETF EW | 11.16% | 16.51% | 0.68 | -18.83% | 2.492 |
| Pure Crowding | 22.08% | 34.31% | 0.64 | -17.38% | 5.597 |
| CSI 300 B&H | 1.44% | 19.69% | 0.07 | -45.10% | 1.132 |
| Mom-Crowding | 12.12% | 16.41% | 0.74 | -19.42% | 2.684 |
| Mom-Crowding+Trend | 9.16% | 12.77% | 0.72 | -18.77% | 2.131 |
| Pure 5D Mom | 8.13% | 16.91% | 0.48 | -20.81% | 1.963 |
