...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Period-2018%E2%80%932026%20%C2%B7%2054641%20obs-4caf50?style=for-the-badge&labelColor=4a4f59" alt="Period">
...
本次真实数据运行覆盖 2018-01-02 至 2026-08-20，共 30 只 ETF，合计 54641 条日频记录，数据由 Tushare 成功下载。
...
|:--|--:|--:|--:|--:|--:|
| 全 ETF 等权 | 11.12% | 16.52% | 0.67 | -18.83% | 2.483 |
| 纯拥挤度 top30 对照组 | 22.04% | 34.32% | 0.64 | -17.38% | 5.577 |
| 沪深300 ETF 买入持有 | 1.37% | 19.70% | 0.07 | -45.10% | 1.125 |
| 动量 - 拥挤度惩罚 | 12.12% | 16.41% | 0.74 | -19.42% | 2.683 |
| 动量 - 拥挤度惩罚 + 趋势过滤 | 9.16% | 12.77% | 0.72 | -18.77% | 2.131 |
| 纯 5 日动量 top30 | 8.11% | 16.91% | 0.48 | -20.81% | 1.960 |

解读要点：

- RRP ETF 池带来真正改善：多资产分散让策略不再被 A 股单一风险源支配。
- 未加趋势过滤的惩罚动量版本年化 12.12%、Sharpe 0.74，显著高于纯 5 日动量和沪深300 ETF。
- 加入 MA200 趋势过滤后，年化为 9.16%、Sharpe 0.72，最大回撤从未过滤版的 -19.42% 降至 -18.77%，更适合作为稳健默认配置。
...
The latest real-data run covers 2018-01-02 to 2026-08-20, with 30 ETFs, 54641 daily observations downloaded from Tushare.
...
|:--|--:|--:|--:|--:|--:|
| All-ETF EW | 11.12% | 16.52% | 0.67 | -18.83% | 2.483 |
| Pure Crowding | 22.04% | 34.32% | 0.64 | -17.38% | 5.577 |
| CSI 300 B&H | 1.37% | 19.70% | 0.07 | -45.10% | 1.125 |
| Mom-Crowding | 12.12% | 16.41% | 0.74 | -19.42% | 2.683 |
| Mom-Crowding+Trend | 9.16% | 12.77% | 0.72 | -18.77% | 2.131 |
| Pure 5D Mom | 8.11% | 16.91% | 0.48 | -20.81% | 1.960 |
...
- The MA200 trend filter lowers annual return to 9.16%, but reduces max drawdown from -19.42% to -18.77%, making it the more conservative default.
