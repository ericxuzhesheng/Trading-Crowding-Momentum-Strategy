...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Period-2018-2026%20%7C%2055391%20obs-4caf50?style=for-the-badge&labelColor=4a4f59" alt="Period">
...
本次前复权数据运行覆盖 2018-01-02 至 2026-09-24，配置中共有 30 只场内基金，各标的按可用历史进入，合计 55391 条日频记录。
...
|:---|---:|---:|---:|---:|---:|
| 全配置资产等权参照 | 8.21% | 12.56% | 0.71 | -15.95% | 1.991 |
| 复合拥挤度得分对照 | 13.15% | 14.40% | 0.96 | -15.82% | 2.940 |
| 沪深300 ETF 买入持有 | 2.86% | 19.57% | 0.25 | -42.16% | 1.279 |
| 凸优化动量 - 拥挤度 | 13.67% | 12.09% | 1.16 | -11.54% | 3.059 |
| 凸优化动量 - 拥挤度 + 趋势过滤 | 9.40% | 10.77% | 0.92 | -13.12% | 2.189 |
| 动量 - 拥挤度 top30 上限等权 | 9.95% | 14.36% | 0.76 | -17.83% | 2.289 |
| 动量 - 拥挤度 top30 上限等权 + 趋势过滤 | 7.72% | 12.73% | 0.67 | -19.23% | 1.914 |
| 5 日动量对照 | 5.85% | 14.97% | 0.47 | -20.04% | 1.642 |
...
- 主实验「凸优化动量 - 拥挤度」在全样本记录年化 13.67%、标准 Sharpe 1.16、最大回撤 -11.54%，周均 L1 换手为 0.405。
...
|---:|:---|---:|---:|---:|---:|---:|
| 0 bps | 情景 | 14.38% | 12.10% | 1.213 | -11.36% | 3.230 |
| 1 bps | 情景 | 14.14% | 12.09% | 1.195 | -11.42% | 3.172 |
| 2 bps | 情景 | 13.91% | 12.09% | 1.178 | -11.48% | 3.115 |
| 3 bps | 基准 | 13.67% | 12.09% | 1.160 | -11.54% | 3.059 |
| 5 bps | 情景 | 13.20% | 12.09% | 1.125 | -11.67% | 2.951 |
| 10 bps | 情景 | 12.04% | 12.08% | 1.037 | -11.98% | 2.696 |
...
The latest forward-adjusted run covers 2018-01-02 to 2026-09-24 and contains 55391 daily observations across 30 configured listed funds over their available histories.
...
|:---|---:|---:|---:|---:|---:|
| Configured-Universe EW Reference | 8.21% | 12.56% | 0.71 | -15.95% | 1.991 |
| Composite Crowding-Score Control | 13.15% | 14.40% | 0.96 | -15.82% | 2.940 |
| CSI 300 Buy & Hold | 2.86% | 19.57% | 0.25 | -42.16% | 1.279 |
| Convex Mom-Crowding | 13.67% | 12.09% | 1.16 | -11.54% | 3.059 |
| Convex Mom-Crowding + Trend | 9.40% | 10.77% | 0.92 | -13.12% | 2.189 |
| Capped Top-30% Mom-Crowding | 9.95% | 14.36% | 0.76 | -17.83% | 2.289 |
| Capped Top-30% Mom-Crowding + Trend | 7.72% | 12.73% | 0.67 | -19.23% | 1.914 |
| 5D Momentum Control | 5.85% | 14.97% | 0.47 | -20.04% | 1.642 |
...
- The main Convex Mom-Crowding experiment records 13.67% annualized return, a standard Sharpe of 1.16, -11.54% max drawdown, and 0.405 average weekly L1 turnover over the full sample.
