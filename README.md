...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Period-2018-2026%20%7C%2055001%20obs-4caf50?style=for-the-badge&labelColor=4a4f59" alt="Period">
...
本次前复权数据运行覆盖 2018-01-02 至 2026-09-07，配置中共有 30 只场内基金，各标的按可用历史进入，合计 55001 条日频记录。
...
|:---|---:|---:|---:|---:|---:|
| 全配置资产等权参照 | 8.49% | 12.56% | 0.74 | -15.95% | 2.028 |
| 复合拥挤度得分对照 | 13.42% | 14.43% | 0.98 | -15.82% | 2.983 |
| 沪深300 ETF 买入持有 | 3.18% | 19.61% | 0.26 | -42.16% | 1.313 |
| 凸优化动量 - 拥挤度 | 14.01% | 12.11% | 1.18 | -11.54% | 3.120 |
| 凸优化动量 - 拥挤度 + 趋势过滤 | 9.47% | 10.80% | 0.92 | -13.12% | 2.193 |
| 动量 - 拥挤度 top30 上限等权 | 10.19% | 14.39% | 0.77 | -16.76% | 2.322 |
| 动量 - 拥挤度 top30 上限等权 + 趋势过滤 | 7.83% | 12.76% | 0.68 | -19.23% | 1.923 |
| 5 日动量对照 | 5.95% | 15.00% | 0.47 | -19.09% | 1.651 |
...
- 主实验「凸优化动量 - 拥挤度」在全样本记录年化 14.01%、标准 Sharpe 1.18、最大回撤 -11.54%，周均 L1 换手为 0.404。
- 在相同信号定义下，旧 top30% 上限等权配置的 Sharpe 为 0.77、最大回撤为 -16.76%；凸优化配置对应 1.18 和 -11.54%。两种配置的资产纳入、持仓上限和实际总暴露均有差异，因此这里只报告观察到的比较。
...
|---:|:---|---:|---:|---:|---:|---:|
| 0 bps | 情景 | 14.72% | 12.12% | 1.237 | -11.36% | 3.293 |
| 1 bps | 情景 | 14.48% | 12.12% | 1.220 | -11.42% | 3.234 |
| 2 bps | 情景 | 14.25% | 12.11% | 1.202 | -11.48% | 3.177 |
| 3 bps | 基准 | 14.01% | 12.11% | 1.185 | -11.54% | 3.120 |
| 5 bps | 情景 | 13.54% | 12.11% | 1.149 | -11.67% | 3.010 |
| 10 bps | 情景 | 12.37% | 12.10% | 1.061 | -11.98% | 2.752 |
...
The latest forward-adjusted run covers 2018-01-02 to 2026-09-07 and contains 55001 daily observations across 30 configured listed funds over their available histories.
...
|:---|---:|---:|---:|---:|---:|
| Configured-Universe EW Reference | 8.49% | 12.56% | 0.74 | -15.95% | 2.028 |
| Composite Crowding-Score Control | 13.42% | 14.43% | 0.98 | -15.82% | 2.983 |
| CSI 300 Buy & Hold | 3.18% | 19.61% | 0.26 | -42.16% | 1.313 |
| Convex Mom-Crowding | 14.01% | 12.11% | 1.18 | -11.54% | 3.120 |
| Convex Mom-Crowding + Trend | 9.47% | 10.80% | 0.92 | -13.12% | 2.193 |
| Capped Top-30% Mom-Crowding | 10.19% | 14.39% | 0.77 | -16.76% | 2.322 |
| Capped Top-30% Mom-Crowding + Trend | 7.83% | 12.76% | 0.68 | -19.23% | 1.923 |
| 5D Momentum Control | 5.95% | 15.00% | 0.47 | -19.09% | 1.651 |
...
- The main Convex Mom-Crowding experiment records 14.01% annualized return, a standard Sharpe of 1.18, -11.54% max drawdown, and 0.404 average weekly L1 turnover over the full sample.
- Under the same signal definition, the legacy capped top-30% configuration records Sharpe of 0.77 and max drawdown of -16.76%; the convex configuration records 1.18 and -11.54%. Eligible assets, position caps, and resulting exposure also differ, so the comparison does not isolate a causal effect.
...
|---:|:---|---:|---:|---:|---:|---:|
| 0 bps | Scenario | 14.72% | 12.12% | 1.237 | -11.36% | 3.293 |
| 1 bps | Scenario | 14.48% | 12.12% | 1.220 | -11.42% | 3.234 |
| 2 bps | Scenario | 14.25% | 12.11% | 1.202 | -11.48% | 3.177 |
| 3 bps | Base | 14.01% | 12.11% | 1.185 | -11.54% | 3.120 |
| 5 bps | Scenario | 13.54% | 12.11% | 1.149 | -11.67% | 3.010 |
| 10 bps | Scenario | 12.37% | 12.10% | 1.061 | -11.98% | 2.752 |
