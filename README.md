...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Period-2018-2026%20%7C%2055181%20obs-4caf50?style=for-the-badge&labelColor=4a4f59" alt="Period">
...
本次前复权数据运行覆盖 2018-01-02 至 2026-09-15，配置中共有 30 只场内基金，各标的按可用历史进入，合计 55181 条日频记录。
...
|:---|---:|---:|---:|---:|---:|
| 全配置资产等权参照 | 8.14% | 12.55% | 0.71 | -15.95% | 1.975 |
| 复合拥挤度得分对照 | 13.17% | 14.42% | 0.96 | -15.82% | 2.933 |
| 沪深300 ETF 买入持有 | 2.89% | 19.59% | 0.25 | -42.16% | 1.281 |
| 凸优化动量 - 拥挤度 | 13.70% | 12.11% | 1.16 | -11.54% | 3.056 |
| 凸优化动量 - 拥挤度 + 趋势过滤 | 9.40% | 10.79% | 0.92 | -13.12% | 2.185 |
| 动量 - 拥挤度 top30 上限等权 | 9.93% | 14.38% | 0.76 | -17.83% | 2.280 |
| 动量 - 拥挤度 top30 上限等权 + 趋势过滤 | 7.73% | 12.75% | 0.67 | -19.23% | 1.912 |
| 5 日动量对照 | 5.75% | 14.98% | 0.46 | -20.04% | 1.627 |
...
- 主实验「凸优化动量 - 拥挤度」在全样本记录年化 13.70%、标准 Sharpe 1.16、最大回撤 -11.54%，周均 L1 换手为 0.405。
...
|---:|:---|---:|---:|---:|---:|---:|
| 0 bps | 情景 | 14.41% | 12.11% | 1.214 | -11.36% | 3.226 |
| 1 bps | 情景 | 14.17% | 12.11% | 1.197 | -11.42% | 3.168 |
| 2 bps | 情景 | 13.94% | 12.11% | 1.179 | -11.48% | 3.112 |
| 3 bps | 基准 | 13.70% | 12.11% | 1.162 | -11.54% | 3.056 |
| 5 bps | 情景 | 13.23% | 12.10% | 1.126 | -11.67% | 2.949 |
| 10 bps | 情景 | 12.07% | 12.10% | 1.038 | -11.98% | 2.695 |
...
The latest forward-adjusted run covers 2018-01-02 to 2026-09-15 and contains 55181 daily observations across 30 configured listed funds over their available histories.
...
|:---|---:|---:|---:|---:|---:|
| Configured-Universe EW Reference | 8.14% | 12.55% | 0.71 | -15.95% | 1.975 |
| Composite Crowding-Score Control | 13.17% | 14.42% | 0.96 | -15.82% | 2.933 |
| CSI 300 Buy & Hold | 2.89% | 19.59% | 0.25 | -42.16% | 1.281 |
| Convex Mom-Crowding | 13.70% | 12.11% | 1.16 | -11.54% | 3.056 |
| Convex Mom-Crowding + Trend | 9.40% | 10.79% | 0.92 | -13.12% | 2.185 |
| Capped Top-30% Mom-Crowding | 9.93% | 14.38% | 0.76 | -17.83% | 2.280 |
| Capped Top-30% Mom-Crowding + Trend | 7.73% | 12.75% | 0.67 | -19.23% | 1.912 |
| 5D Momentum Control | 5.75% | 14.98% | 0.46 | -20.04% | 1.627 |
...
- The main Convex Mom-Crowding experiment records 13.70% annualized return, a standard Sharpe of 1.16, -11.54% max drawdown, and 0.405 average weekly L1 turnover over the full sample.
