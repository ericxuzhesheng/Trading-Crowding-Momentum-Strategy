...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Period-2018-2026%20%7C%2055301%20obs-4caf50?style=for-the-badge&labelColor=4a4f59" alt="Period">
...
本次前复权数据运行覆盖 2018-01-02 至 2026-09-21，配置中共有 30 只场内基金，各标的按可用历史进入，合计 55301 条日频记录。
...
|:---|---:|---:|---:|---:|---:|
| 全配置资产等权参照 | 8.39% | 12.56% | 0.73 | -15.95% | 2.019 |
| 复合拥挤度得分对照 | 13.26% | 14.41% | 0.97 | -15.82% | 2.962 |
| 沪深300 ETF 买入持有 | 3.10% | 19.58% | 0.26 | -42.16% | 1.305 |
| 凸优化动量 - 拥挤度 | 13.73% | 12.10% | 1.16 | -11.54% | 3.070 |
| 凸优化动量 - 拥挤度 + 趋势过滤 | 9.39% | 10.78% | 0.92 | -13.12% | 2.187 |
| 动量 - 拥挤度 top30 上限等权 | 10.04% | 14.37% | 0.76 | -17.83% | 2.303 |
| 动量 - 拥挤度 top30 上限等权 + 趋势过滤 | 7.76% | 12.73% | 0.67 | -19.23% | 1.918 |
| 5 日动量对照 | 5.96% | 14.98% | 0.48 | -20.04% | 1.656 |
...
- 主实验「凸优化动量 - 拥挤度」在全样本记录年化 13.73%、标准 Sharpe 1.16、最大回撤 -11.54%，周均 L1 换手为 0.405。
...
|---:|:---|---:|---:|---:|---:|---:|
| 0 bps | 情景 | 14.44% | 12.10% | 1.217 | -11.36% | 3.241 |
| 1 bps | 情景 | 14.20% | 12.10% | 1.200 | -11.42% | 3.183 |
| 2 bps | 情景 | 13.97% | 12.10% | 1.182 | -11.48% | 3.126 |
| 3 bps | 基准 | 13.73% | 12.10% | 1.165 | -11.54% | 3.070 |
| 5 bps | 情景 | 13.26% | 12.10% | 1.129 | -11.67% | 2.961 |
| 10 bps | 情景 | 12.10% | 12.09% | 1.041 | -11.98% | 2.706 |
...
The latest forward-adjusted run covers 2018-01-02 to 2026-09-21 and contains 55301 daily observations across 30 configured listed funds over their available histories.
...
|:---|---:|---:|---:|---:|---:|
| Configured-Universe EW Reference | 8.39% | 12.56% | 0.73 | -15.95% | 2.019 |
| Composite Crowding-Score Control | 13.26% | 14.41% | 0.97 | -15.82% | 2.962 |
| CSI 300 Buy & Hold | 3.10% | 19.58% | 0.26 | -42.16% | 1.305 |
| Convex Mom-Crowding | 13.73% | 12.10% | 1.16 | -11.54% | 3.070 |
| Convex Mom-Crowding + Trend | 9.39% | 10.78% | 0.92 | -13.12% | 2.187 |
| Capped Top-30% Mom-Crowding | 10.04% | 14.37% | 0.76 | -17.83% | 2.303 |
| Capped Top-30% Mom-Crowding + Trend | 7.76% | 12.73% | 0.67 | -19.23% | 1.918 |
| 5D Momentum Control | 5.96% | 14.98% | 0.48 | -20.04% | 1.656 |
...
- The main Convex Mom-Crowding experiment records 13.73% annualized return, a standard Sharpe of 1.16, -11.54% max drawdown, and 0.405 average weekly L1 turnover over the full sample.
