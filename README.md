...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Period-2018%E2%80%932026%20%C2%B7%2054521%20obs-4caf50?style=for-the-badge&labelColor=4a4f59" alt="Period">
...
本次真实数据运行覆盖 2018-01-02 至 2026-08-14，共 30 只 ETF，合计 54521 条日频记录，数据由 Tushare 成功下载。
...
|:--|--:|--:|--:|--:|--:|
| 全 ETF 等权 | 11.30% | 16.50% | 0.68 | -18.83% | 2.514 |
| 纯拥挤度 top30 对照组 | 22.16% | 34.35% | 0.65 | -17.38% | 5.608 |
| 沪深300 ETF 买入持有 | 1.56% | 19.68% | 0.08 | -45.10% | 1.143 |
| 动量 - 拥挤度惩罚 | 12.29% | 16.41% | 0.75 | -19.42% | 2.714 |
| 动量 - 拥挤度惩罚 + 趋势过滤 | 9.23% | 12.78% | 0.72 | -18.77% | 2.139 |
| 纯 5 日动量 top30 | 8.23% | 16.88% | 0.49 | -20.81% | 1.976 |

解读要点：

- RRP ETF 池带来真正改善：多资产分散让策略不再被 A 股单一风险源支配。
- 未加趋势过滤的惩罚动量版本年化 12.29%、Sharpe 0.75，显著高于纯 5 日动量和沪深300 ETF。
- 加入 MA200 趋势过滤后，年化为 9.23%、Sharpe 0.72，最大回撤从未过滤版的 -19.42% 降至 -18.77%，更适合作为稳健默认配置。
...
The latest real-data run covers 2018-01-02 to 2026-08-14, with 30 ETFs, 54521 daily observations downloaded from Tushare.
...
|:--|--:|--:|--:|--:|--:|
| All-ETF EW | 11.30% | 16.50% | 0.68 | -18.83% | 2.514 |
| Pure Crowding | 22.16% | 34.35% | 0.65 | -17.38% | 5.608 |
| CSI 300 B&H | 1.56% | 19.68% | 0.08 | -45.10% | 1.143 |
| Mom-Crowding | 12.29% | 16.41% | 0.75 | -19.42% | 2.714 |
| Mom-Crowding+Trend | 9.23% | 12.78% | 0.72 | -18.77% | 2.139 |
| Pure 5D Mom | 8.23% | 16.88% | 0.49 | -20.81% | 1.976 |
...
- The unfiltered penalized momentum strategy earns 12.29% annualized with a 0.75 Sharpe, outperforming pure 5-day momentum and CSI 300 ETF buy-and-hold.
- The MA200 trend filter lowers annual return to 9.23%, but reduces max drawdown from -19.42% to -18.77%, making it the more conservative default.
