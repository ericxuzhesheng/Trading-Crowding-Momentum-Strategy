...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Period-2018-2026%20%7C%2054851%20obs-4caf50?style=for-the-badge&labelColor=4a4f59" alt="Period">
...
本次前复权数据运行覆盖 2018-01-02 至 2026-08-31，配置中共有 30 只场内基金，各标的按可用历史进入，合计 54851 条日频记录。
...
|:---|---:|---:|---:|---:|---:|
| 全配置资产等权参照 | 8.63% | 12.56% | 0.75 | -15.95% | 2.048 |
| 复合拥挤度得分对照 | 13.60% | 14.43% | 0.99 | -15.82% | 3.017 |
| 沪深300 ETF 买入持有 | 3.32% | 19.63% | 0.27 | -42.16% | 1.327 |
| 凸优化动量 - 拥挤度 | 14.19% | 12.11% | 1.20 | -11.54% | 3.155 |
| 凸优化动量 - 拥挤度 + 趋势过滤 | 9.61% | 10.81% | 0.94 | -13.12% | 2.214 |
| 动量 - 拥挤度 top30 上限等权 | 10.51% | 14.39% | 0.79 | -16.08% | 2.376 |
| 动量 - 拥挤度 top30 上限等权 + 趋势过滤 | 7.94% | 12.78% | 0.68 | -19.23% | 1.938 |
| 5 日动量对照 | 6.18% | 15.00% | 0.49 | -18.36% | 1.680 |
...
- 主实验「凸优化动量 - 拥挤度」在全样本记录年化 14.19%、标准 Sharpe 1.20、最大回撤 -11.54%，周均 L1 换手为 0.404。
...
|---:|:---|---:|---:|---:|---:|---:|
| 0 bps | 情景 | 14.90% | 12.11% | 1.251 | -11.36% | 3.328 |
| 1 bps | 情景 | 14.66% | 12.11% | 1.234 | -11.42% | 3.269 |
| 2 bps | 情景 | 14.42% | 12.11% | 1.216 | -11.48% | 3.211 |
| 3 bps | 基准 | 14.19% | 12.11% | 1.199 | -11.54% | 3.155 |
| 5 bps | 情景 | 13.72% | 12.10% | 1.163 | -11.67% | 3.044 |
| 10 bps | 情景 | 12.55% | 12.10% | 1.075 | -11.98% | 2.784 |
...
The latest forward-adjusted run covers 2018-01-02 to 2026-08-31 and contains 54851 daily observations across 30 configured listed funds over their available histories.
...
|:---|---:|---:|---:|---:|---:|
| Configured-Universe EW Reference | 8.63% | 12.56% | 0.75 | -15.95% | 2.048 |
| Composite Crowding-Score Control | 13.60% | 14.43% | 0.99 | -15.82% | 3.017 |
| CSI 300 Buy & Hold | 3.32% | 19.63% | 0.27 | -42.16% | 1.327 |
| Convex Mom-Crowding | 14.19% | 12.11% | 1.20 | -11.54% | 3.155 |
| Convex Mom-Crowding + Trend | 9.61% | 10.81% | 0.94 | -13.12% | 2.214 |
| Capped Top-30% Mom-Crowding | 10.51% | 14.39% | 0.79 | -16.08% | 2.376 |
| Capped Top-30% Mom-Crowding + Trend | 7.94% | 12.78% | 0.68 | -19.23% | 1.938 |
| 5D Momentum Control | 6.18% | 15.00% | 0.49 | -18.36% | 1.680 |
...
- The main Convex Mom-Crowding experiment records 14.19% annualized return, a standard Sharpe of 1.20, -11.54% max drawdown, and 0.404 average weekly L1 turnover over the full sample.
