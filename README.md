...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Period-2018%E2%80%932026%20%C2%B7%2054221%20obs-4caf50?style=for-the-badge&labelColor=4a4f59" alt="Period">
...
本次真实数据运行覆盖 2018-01-02 至 2026-07-31，共 30 只 ETF，合计 54221 条日频记录，数据由 Tushare 成功下载。
...
|:--|--:|--:|--:|--:|--:|
| 全 ETF 等权 | 10.89% | 16.51% | 0.66 | -18.83% | 2.426 |
| 纯拥挤度 top30 对照组 | 21.99% | 34.42% | 0.64 | -17.38% | 5.496 |
| 沪深300 ETF 买入持有 | 1.38% | 19.71% | 0.07 | -45.10% | 1.125 |
| 动量 - 拥挤度惩罚 | 12.15% | 16.43% | 0.74 | -19.42% | 2.673 |
| 动量 - 拥挤度惩罚 + 趋势过滤 | 9.20% | 12.81% | 0.72 | -18.77% | 2.128 |
| 纯 5 日动量 top30 | 8.10% | 16.91% | 0.48 | -20.81% | 1.951 |

解读要点：

- RRP ETF 池带来真正改善：多资产分散让策略不再被 A 股单一风险源支配。
- 未加趋势过滤的惩罚动量版本年化 12.15%、Sharpe 0.74，显著高于纯 5 日动量和沪深300 ETF。
...
The latest real-data run covers 2018-01-02 to 2026-07-31, with 30 ETFs, 54221 daily observations downloaded from Tushare.
...
|:--|--:|--:|--:|--:|--:|
| All-ETF EW | 10.89% | 16.51% | 0.66 | -18.83% | 2.426 |
| Pure Crowding | 21.99% | 34.42% | 0.64 | -17.38% | 5.496 |
| CSI 300 B&H | 1.38% | 19.71% | 0.07 | -45.10% | 1.125 |
| Mom-Crowding | 12.15% | 16.43% | 0.74 | -19.42% | 2.673 |
| Mom-Crowding+Trend | 9.20% | 12.81% | 0.72 | -18.77% | 2.128 |
| Pure 5D Mom | 8.10% | 16.91% | 0.48 | -20.81% | 1.951 |
...
- The unfiltered penalized momentum strategy earns 12.15% annualized with a 0.74 Sharpe, outperforming pure 5-day momentum and CSI 300 ETF buy-and-hold.
