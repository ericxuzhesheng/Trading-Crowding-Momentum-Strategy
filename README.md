...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Period-2018-2026%20%7C%2055211%20obs-4caf50?style=for-the-badge&labelColor=4a4f59" alt="Period">
...
本次前复权数据运行覆盖 2018-01-02 至 2026-09-16，配置中共有 30 只场内基金，各标的按可用历史进入，合计 55211 条日频记录。
...
|:---|---:|---:|---:|---:|---:|
| 全配置资产等权参照 | 8.28% | 12.56% | 0.72 | -15.95% | 1.999 |
| 复合拥挤度得分对照 | 13.24% | 14.42% | 0.97 | -15.82% | 2.951 |
| 沪深300 ETF 买入持有 | 2.96% | 19.58% | 0.25 | -42.16% | 1.289 |
| 凸优化动量 - 拥挤度 | 13.76% | 12.10% | 1.17 | -11.54% | 3.072 |
| 凸优化动量 - 拥挤度 + 趋势过滤 | 9.45% | 10.79% | 0.92 | -13.12% | 2.194 |
| 动量 - 拥挤度 top30 上限等权 | 10.01% | 14.37% | 0.76 | -17.83% | 2.294 |
| 动量 - 拥挤度 top30 上限等权 + 趋势过滤 | 7.75% | 12.74% | 0.67 | -19.23% | 1.916 |
| 5 日动量对照 | 5.87% | 14.98% | 0.47 | -20.04% | 1.643 |
...
- 在相同信号定义下，旧 top30% 上限等权配置的 Sharpe 为 0.76、最大回撤为 -17.83%；凸优化配置对应 1.17 和 -11.54%。两种配置的资产纳入、持仓上限和实际总暴露均有差异，因此这里只报告观察到的比较。
...
|---:|:---|---:|---:|---:|---:|---:|
| 0 bps | 情景 | 14.47% | 12.11% | 1.219 | -11.36% | 3.242 |
| 1 bps | 情景 | 14.24% | 12.11% | 1.201 | -11.42% | 3.185 |
| 2 bps | 情景 | 14.00% | 12.11% | 1.184 | -11.48% | 3.128 |
| 3 bps | 基准 | 13.76% | 12.10% | 1.166 | -11.54% | 3.072 |
| 5 bps | 情景 | 13.30% | 12.10% | 1.131 | -11.67% | 2.964 |
| 10 bps | 情景 | 12.13% | 12.10% | 1.043 | -11.98% | 2.709 |
...
The latest forward-adjusted run covers 2018-01-02 to 2026-09-16 and contains 55211 daily observations across 30 configured listed funds over their available histories.
...
|:---|---:|---:|---:|---:|---:|
| Configured-Universe EW Reference | 8.28% | 12.56% | 0.72 | -15.95% | 1.999 |
| Composite Crowding-Score Control | 13.24% | 14.42% | 0.97 | -15.82% | 2.951 |
| CSI 300 Buy & Hold | 2.96% | 19.58% | 0.25 | -42.16% | 1.289 |
| Convex Mom-Crowding | 13.76% | 12.10% | 1.17 | -11.54% | 3.072 |
| Convex Mom-Crowding + Trend | 9.45% | 10.79% | 0.92 | -13.12% | 2.194 |
| Capped Top-30% Mom-Crowding | 10.01% | 14.37% | 0.76 | -17.83% | 2.294 |
| Capped Top-30% Mom-Crowding + Trend | 7.75% | 12.74% | 0.67 | -19.23% | 1.916 |
| 5D Momentum Control | 5.87% | 14.98% | 0.47 | -20.04% | 1.643 |
...
- Under the same signal definition, the legacy capped top-30% configuration records Sharpe of 0.76 and max drawdown of -17.83%; the convex configuration records 1.17 and -11.54%. Eligible assets, position caps, and resulting exposure also differ, so the comparison does not isolate a causal effect.
