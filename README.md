...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Period-2018%E2%80%932026%20%C2%B7%2054701%20obs-4caf50?style=for-the-badge&labelColor=4a4f59" alt="Period">
...
本次真实数据运行覆盖 2018-01-02 至 2026-08-24，共 30 只 ETF，合计 54701 条日频记录，数据由 Tushare 成功下载。
...
|:--|--:|--:|--:|--:|--:|
| 全 ETF 等权 | 11.07% | 16.51% | 0.67 | -18.83% | 2.478 |
| 纯拥挤度 top30 对照组 | 22.18% | 34.31% | 0.65 | -17.38% | 5.647 |
| 沪深300 ETF 买入持有 | 1.31% | 19.69% | 0.07 | -45.10% | 1.119 |
| 动量 - 拥挤度惩罚 | 12.05% | 16.41% | 0.73 | -19.42% | 2.673 |
| 动量 - 拥挤度惩罚 + 趋势过滤 | 9.13% | 12.76% | 0.72 | -18.77% | 2.128 |
| 纯 5 日动量 top30 | 8.01% | 16.91% | 0.47 | -20.81% | 1.946 |
...
The latest real-data run covers 2018-01-02 to 2026-08-24, with 30 ETFs, 54701 daily observations downloaded from Tushare.
...
|:--|--:|--:|--:|--:|--:|
| All-ETF EW | 11.07% | 16.51% | 0.67 | -18.83% | 2.478 |
| Pure Crowding | 22.18% | 34.31% | 0.65 | -17.38% | 5.647 |
| CSI 300 B&H | 1.31% | 19.69% | 0.07 | -45.10% | 1.119 |
| Mom-Crowding | 12.05% | 16.41% | 0.73 | -19.42% | 2.673 |
| Mom-Crowding+Trend | 9.13% | 12.76% | 0.72 | -18.77% | 2.128 |
| Pure 5D Mom | 8.01% | 16.91% | 0.47 | -20.81% | 1.946 |
