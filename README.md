...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Period-2018-2026%20%7C%2055091%20obs-4caf50?style=for-the-badge&labelColor=4a4f59" alt="Period">
...
本次前复权数据运行覆盖 2018-01-02 至 2026-09-10，配置中共有 30 只场内基金，各标的按可用历史进入，合计 55091 条日频记录。
...
|:---|---:|---:|---:|---:|---:|
| 全配置资产等权参照 | 8.41% | 12.55% | 0.73 | -15.95% | 2.017 |
| 复合拥挤度得分对照 | 13.43% | 14.42% | 0.98 | -15.82% | 2.989 |
| 沪深300 ETF 买入持有 | 3.14% | 19.60% | 0.26 | -42.16% | 1.308 |
| 凸优化动量 - 拥挤度 | 13.90% | 12.11% | 1.18 | -11.54% | 3.096 |
| 凸优化动量 - 拥挤度 + 趋势过滤 | 9.47% | 10.80% | 0.92 | -13.12% | 2.194 |
| 动量 - 拥挤度 top30 上限等权 | 10.19% | 14.38% | 0.77 | -16.76% | 2.323 |
| 动量 - 拥挤度 top30 上限等权 + 趋势过滤 | 7.82% | 12.75% | 0.68 | -19.23% | 1.924 |
| 5 日动量对照 | 5.95% | 14.99% | 0.47 | -19.09% | 1.652 |
...
- 主实验「凸优化动量 - 拥挤度」在全样本记录年化 13.90%、标准 Sharpe 1.18、最大回撤 -11.54%，周均 L1 换手为 0.404。
- 在相同信号定义下，旧 top30% 上限等权配置的 Sharpe 为 0.77、最大回撤为 -16.76%；凸优化配置对应 1.18 和 -11.54%。两种配置的资产纳入、持仓上限和实际总暴露均有差异，因此这里只报告观察到的比较。
- 以 2023-01-01 为界进行时间切分，较早区间 Sharpe 为 1.13，较晚区间为 1.24。这个结果用于检查时间稳定性，不代表完全未观察的样本外检验。
...
|---:|:---|---:|---:|---:|---:|---:|
| 0 bps | 情景 | 14.60% | 12.12% | 1.228 | -11.36% | 3.268 |
| 1 bps | 情景 | 14.37% | 12.11% | 1.211 | -11.42% | 3.210 |
| 2 bps | 情景 | 14.13% | 12.11% | 1.193 | -11.48% | 3.153 |
| 3 bps | 基准 | 13.90% | 12.11% | 1.176 | -11.54% | 3.096 |
| 5 bps | 情景 | 13.43% | 12.11% | 1.141 | -11.67% | 2.987 |
| 10 bps | 情景 | 12.26% | 12.10% | 1.052 | -11.98% | 2.731 |
...
The latest forward-adjusted run covers 2018-01-02 to 2026-09-10 and contains 55091 daily observations across 30 configured listed funds over their available histories.
...
|:---|---:|---:|---:|---:|---:|
| Configured-Universe EW Reference | 8.41% | 12.55% | 0.73 | -15.95% | 2.017 |
| Composite Crowding-Score Control | 13.43% | 14.42% | 0.98 | -15.82% | 2.989 |
| CSI 300 Buy & Hold | 3.14% | 19.60% | 0.26 | -42.16% | 1.308 |
| Convex Mom-Crowding | 13.90% | 12.11% | 1.18 | -11.54% | 3.096 |
| Convex Mom-Crowding + Trend | 9.47% | 10.80% | 0.92 | -13.12% | 2.194 |
| Capped Top-30% Mom-Crowding | 10.19% | 14.38% | 0.77 | -16.76% | 2.323 |
| Capped Top-30% Mom-Crowding + Trend | 7.82% | 12.75% | 0.68 | -19.23% | 1.924 |
| 5D Momentum Control | 5.95% | 14.99% | 0.47 | -19.09% | 1.652 |
...
- The main Convex Mom-Crowding experiment records 13.90% annualized return, a standard Sharpe of 1.18, -11.54% max drawdown, and 0.404 average weekly L1 turnover over the full sample.
...
- A 2023-01-01 temporal split reports Sharpe of 1.13 in the earlier segment and 1.24 in the later segment. This stability diagnostic does not establish a fully untouched out-of-sample test.
