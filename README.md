...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Period-2018-2026%20%7C%2055331%20obs-4caf50?style=for-the-badge&labelColor=4a4f59" alt="Period">
...
本次前复权数据运行覆盖 2018-01-02 至 2026-09-22，配置中共有 30 只场内基金，各标的按可用历史进入，合计 55331 条日频记录。
...
|:---|---:|---:|---:|---:|---:|
| 全配置资产等权参照 | 8.42% | 12.55% | 0.73 | -15.95% | 2.024 |
| 复合拥挤度得分对照 | 13.24% | 14.41% | 0.97 | -15.82% | 2.957 |
| 沪深300 ETF 买入持有 | 3.11% | 19.57% | 0.26 | -42.16% | 1.307 |
| 凸优化动量 - 拥挤度 | 13.76% | 12.10% | 1.17 | -11.54% | 3.079 |
| 凸优化动量 - 拥挤度 + 趋势过滤 | 9.42% | 10.78% | 0.92 | -13.12% | 2.192 |
| 动量 - 拥挤度 top30 上限等权 | 10.10% | 14.36% | 0.77 | -17.83% | 2.313 |
| 动量 - 拥挤度 top30 上限等权 + 趋势过滤 | 7.77% | 12.73% | 0.67 | -19.23% | 1.921 |
| 5 日动量对照 | 6.00% | 14.97% | 0.48 | -20.04% | 1.662 |
...
- 主实验「凸优化动量 - 拥挤度」在全样本记录年化 13.76%、标准 Sharpe 1.17、最大回撤 -11.54%，周均 L1 换手为 0.405。
- 在相同信号定义下，旧 top30% 上限等权配置的 Sharpe 为 0.77、最大回撤为 -17.83%；凸优化配置对应 1.17 和 -11.54%。两种配置的资产纳入、持仓上限和实际总暴露均有差异，因此这里只报告观察到的比较。
- 以 2023-01-01 为界进行时间切分，较早区间 Sharpe 为 1.13，较晚区间为 1.22。这个结果用于检查时间稳定性，不代表完全未观察的样本外检验。
...
|---:|:---|---:|---:|---:|---:|---:|
| 0 bps | 情景 | 14.47% | 12.10% | 1.220 | -11.36% | 3.250 |
| 1 bps | 情景 | 14.24% | 12.10% | 1.202 | -11.42% | 3.192 |
| 2 bps | 情景 | 14.00% | 12.10% | 1.185 | -11.48% | 3.135 |
| 3 bps | 基准 | 13.76% | 12.10% | 1.167 | -11.54% | 3.079 |
| 5 bps | 情景 | 13.29% | 12.09% | 1.132 | -11.67% | 2.969 |
| 10 bps | 情景 | 12.13% | 12.09% | 1.043 | -11.98% | 2.713 |
...
The latest forward-adjusted run covers 2018-01-02 to 2026-09-22 and contains 55331 daily observations across 30 configured listed funds over their available histories.
...
|:---|---:|---:|---:|---:|---:|
| Configured-Universe EW Reference | 8.42% | 12.55% | 0.73 | -15.95% | 2.024 |
| Composite Crowding-Score Control | 13.24% | 14.41% | 0.97 | -15.82% | 2.957 |
| CSI 300 Buy & Hold | 3.11% | 19.57% | 0.26 | -42.16% | 1.307 |
| Convex Mom-Crowding | 13.76% | 12.10% | 1.17 | -11.54% | 3.079 |
| Convex Mom-Crowding + Trend | 9.42% | 10.78% | 0.92 | -13.12% | 2.192 |
| Capped Top-30% Mom-Crowding | 10.10% | 14.36% | 0.77 | -17.83% | 2.313 |
| Capped Top-30% Mom-Crowding + Trend | 7.77% | 12.73% | 0.67 | -19.23% | 1.921 |
| 5D Momentum Control | 6.00% | 14.97% | 0.48 | -20.04% | 1.662 |
...
- The main Convex Mom-Crowding experiment records 13.76% annualized return, a standard Sharpe of 1.17, -11.54% max drawdown, and 0.405 average weekly L1 turnover over the full sample.
- Under the same signal definition, the legacy capped top-30% configuration records Sharpe of 0.77 and max drawdown of -17.83%; the convex configuration records 1.17 and -11.54%. Eligible assets, position caps, and resulting exposure also differ, so the comparison does not isolate a causal effect.
- A 2023-01-01 temporal split reports Sharpe of 1.13 in the earlier segment and 1.22 in the later segment. This stability diagnostic does not establish a fully untouched out-of-sample test.
