...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Period-2018-2026%20%7C%2055121%20obs-4caf50?style=for-the-badge&labelColor=4a4f59" alt="Period">
...
本次前复权数据运行覆盖 2018-01-02 至 2026-09-11，配置中共有 30 只场内基金，各标的按可用历史进入，合计 55121 条日频记录。
...
|:---|---:|---:|---:|---:|---:|
| 全配置资产等权参照 | 8.25% | 12.56% | 0.72 | -15.95% | 1.992 |
| 复合拥挤度得分对照 | 13.31% | 14.42% | 0.97 | -15.82% | 2.963 |
| 沪深300 ETF 买入持有 | 3.04% | 19.60% | 0.26 | -42.16% | 1.297 |
| 凸优化动量 - 拥挤度 | 13.80% | 12.11% | 1.17 | -11.54% | 3.076 |
| 凸优化动量 - 拥挤度 + 趋势过滤 | 9.43% | 10.79% | 0.92 | -13.12% | 2.188 |
| 动量 - 拥挤度 top30 上限等权 | 10.06% | 14.38% | 0.76 | -17.08% | 2.301 |
| 动量 - 拥挤度 top30 上限等权 + 趋势过滤 | 7.78% | 12.75% | 0.67 | -19.23% | 1.917 |
| 5 日动量对照 | 5.86% | 14.99% | 0.47 | -19.36% | 1.641 |
...
- 主实验「凸优化动量 - 拥挤度」在全样本记录年化 13.80%、标准 Sharpe 1.17、最大回撤 -11.54%，周均 L1 换手为 0.404。
- 在相同信号定义下，旧 top30% 上限等权配置的 Sharpe 为 0.76、最大回撤为 -17.08%；凸优化配置对应 1.17 和 -11.54%。两种配置的资产纳入、持仓上限和实际总暴露均有差异，因此这里只报告观察到的比较。
...
|---:|:---|---:|---:|---:|---:|---:|
| 0 bps | 情景 | 14.51% | 12.12% | 1.221 | -11.36% | 3.246 |
| 1 bps | 情景 | 14.27% | 12.11% | 1.204 | -11.42% | 3.188 |
| 2 bps | 情景 | 14.04% | 12.11% | 1.186 | -11.48% | 3.131 |
| 3 bps | 基准 | 13.80% | 12.11% | 1.168 | -11.54% | 3.076 |
| 5 bps | 情景 | 13.33% | 12.11% | 1.133 | -11.67% | 2.967 |
| 10 bps | 情景 | 12.17% | 12.10% | 1.045 | -11.98% | 2.713 |
...
The latest forward-adjusted run covers 2018-01-02 to 2026-09-11 and contains 55121 daily observations across 30 configured listed funds over their available histories.
...
|:---|---:|---:|---:|---:|---:|
| Configured-Universe EW Reference | 8.25% | 12.56% | 0.72 | -15.95% | 1.992 |
| Composite Crowding-Score Control | 13.31% | 14.42% | 0.97 | -15.82% | 2.963 |
| CSI 300 Buy & Hold | 3.04% | 19.60% | 0.26 | -42.16% | 1.297 |
| Convex Mom-Crowding | 13.80% | 12.11% | 1.17 | -11.54% | 3.076 |
| Convex Mom-Crowding + Trend | 9.43% | 10.79% | 0.92 | -13.12% | 2.188 |
| Capped Top-30% Mom-Crowding | 10.06% | 14.38% | 0.76 | -17.08% | 2.301 |
| Capped Top-30% Mom-Crowding + Trend | 7.78% | 12.75% | 0.67 | -19.23% | 1.917 |
| 5D Momentum Control | 5.86% | 14.99% | 0.47 | -19.36% | 1.641 |
...
- The main Convex Mom-Crowding experiment records 13.80% annualized return, a standard Sharpe of 1.17, -11.54% max drawdown, and 0.404 average weekly L1 turnover over the full sample.
- Under the same signal definition, the legacy capped top-30% configuration records Sharpe of 0.76 and max drawdown of -17.08%; the convex configuration records 1.17 and -11.54%. Eligible assets, position caps, and resulting exposure also differ, so the comparison does not isolate a causal effect.
