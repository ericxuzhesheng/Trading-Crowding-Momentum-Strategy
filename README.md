...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Period-2018-2026%20%7C%2055151%20obs-4caf50?style=for-the-badge&labelColor=4a4f59" alt="Period">
...
本次前复权数据运行覆盖 2018-01-02 至 2026-09-14，配置中共有 30 只场内基金，各标的按可用历史进入，合计 55151 条日频记录。
...
|:---|---:|---:|---:|---:|---:|
| 全配置资产等权参照 | 8.17% | 12.56% | 0.71 | -15.95% | 1.981 |
| 复合拥挤度得分对照 | 13.20% | 14.42% | 0.96 | -15.82% | 2.940 |
| 沪深300 ETF 买入持有 | 2.96% | 19.59% | 0.25 | -42.16% | 1.289 |
| 凸优化动量 - 拥挤度 | 13.77% | 12.11% | 1.17 | -11.54% | 3.071 |
| 凸优化动量 - 拥挤度 + 趋势过滤 | 9.43% | 10.79% | 0.92 | -13.12% | 2.190 |
| 动量 - 拥挤度 top30 上限等权 | 10.00% | 14.38% | 0.76 | -17.43% | 2.291 |
| 动量 - 拥挤度 top30 上限等权 + 趋势过滤 | 7.75% | 12.75% | 0.67 | -19.23% | 1.915 |
| 5 日动量对照 | 5.81% | 14.98% | 0.47 | -19.66% | 1.635 |
...
- 主实验「凸优化动量 - 拥挤度」在全样本记录年化 13.77%、标准 Sharpe 1.17、最大回撤 -11.54%，周均 L1 换手为 0.405。
- 在相同信号定义下，旧 top30% 上限等权配置的 Sharpe 为 0.76、最大回撤为 -17.43%；凸优化配置对应 1.17 和 -11.54%。两种配置的资产纳入、持仓上限和实际总暴露均有差异，因此这里只报告观察到的比较。
...
|---:|:---|---:|---:|---:|---:|---:|
| 0 bps | 情景 | 14.47% | 12.11% | 1.219 | -11.36% | 3.241 |
| 1 bps | 情景 | 14.24% | 12.11% | 1.202 | -11.42% | 3.183 |
| 2 bps | 情景 | 14.00% | 12.11% | 1.184 | -11.48% | 3.126 |
| 3 bps | 基准 | 13.77% | 12.11% | 1.167 | -11.54% | 3.071 |
| 5 bps | 情景 | 13.30% | 12.10% | 1.131 | -11.67% | 2.962 |
| 10 bps | 情景 | 12.13% | 12.10% | 1.043 | -11.98% | 2.707 |
...
The latest forward-adjusted run covers 2018-01-02 to 2026-09-14 and contains 55151 daily observations across 30 configured listed funds over their available histories.
...
|:---|---:|---:|---:|---:|---:|
| Configured-Universe EW Reference | 8.17% | 12.56% | 0.71 | -15.95% | 1.981 |
| Composite Crowding-Score Control | 13.20% | 14.42% | 0.96 | -15.82% | 2.940 |
| CSI 300 Buy & Hold | 2.96% | 19.59% | 0.25 | -42.16% | 1.289 |
| Convex Mom-Crowding | 13.77% | 12.11% | 1.17 | -11.54% | 3.071 |
| Convex Mom-Crowding + Trend | 9.43% | 10.79% | 0.92 | -13.12% | 2.190 |
| Capped Top-30% Mom-Crowding | 10.00% | 14.38% | 0.76 | -17.43% | 2.291 |
| Capped Top-30% Mom-Crowding + Trend | 7.75% | 12.75% | 0.67 | -19.23% | 1.915 |
| 5D Momentum Control | 5.81% | 14.98% | 0.47 | -19.66% | 1.635 |
...
- The main Convex Mom-Crowding experiment records 13.77% annualized return, a standard Sharpe of 1.17, -11.54% max drawdown, and 0.405 average weekly L1 turnover over the full sample.
- Under the same signal definition, the legacy capped top-30% configuration records Sharpe of 0.76 and max drawdown of -17.43%; the convex configuration records 1.17 and -11.54%. Eligible assets, position caps, and resulting exposure also differ, so the comparison does not isolate a causal effect.
...
|---:|:---|---:|---:|---:|---:|---:|
| 0 bps | Scenario | 14.47% | 12.11% | 1.219 | -11.36% | 3.241 |
| 1 bps | Scenario | 14.24% | 12.11% | 1.202 | -11.42% | 3.183 |
| 2 bps | Scenario | 14.00% | 12.11% | 1.184 | -11.48% | 3.126 |
| 3 bps | Base | 13.77% | 12.11% | 1.167 | -11.54% | 3.071 |
| 5 bps | Scenario | 13.30% | 12.10% | 1.131 | -11.67% | 2.962 |
| 10 bps | Scenario | 12.13% | 12.10% | 1.043 | -11.98% | 2.707 |
