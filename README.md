...
<p align="center">
  <a href="#中文说明"><img src="https://img.shields.io/badge/%E8%AF%AD%E8%A8%80-%E4%B8%AD%E6%96%87-ff4b3e?style=for-the-badge&labelColor=343a46" alt="中文"></a>
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/%E8%B5%84%E4%BA%A7%E6%B1%A0-30%E5%8F%AA%E5%A4%9A%E8%B5%84%E4%BA%A7ETF-f3c63f?style=for-the-badge&labelColor=4a4f59" alt="Universe">
...
本次真实数据运行覆盖 2018-01-02 至 2026-07-29，共 30 只 ETF，合计 54161 条日频记录，数据由 Tushare 成功下载。
...
|:--|--:|--:|--:|--:|--:|
| 全 ETF 等权 | 10.86% | 16.50% | 0.66 | -18.83% | 2.419 |
| 纯拥挤度 top30 对照组 | 22.00% | 34.43% | 0.64 | -17.38% | 5.495 |
| 沪深300 ETF 买入持有 | 1.39% | 19.71% | 0.07 | -45.10% | 1.126 |
| 动量 - 拥挤度惩罚 | 12.12% | 16.44% | 0.74 | -19.42% | 2.664 |
| 动量 - 拥挤度惩罚 + 趋势过滤 | 9.20% | 12.81% | 0.72 | -18.77% | 2.126 |
| 纯 5 日动量 top30 | 8.07% | 16.92% | 0.48 | -20.81% | 1.945 |

解读要点：

- RRP ETF 池带来真正改善：多资产分散让策略不再被 A 股单一风险源支配。
- 未加趋势过滤的惩罚动量版本年化 12.12%、Sharpe 0.74，显著高于纯 5 日动量和沪深300 ETF。
- 加入 MA200 趋势过滤后，年化为 9.20%、Sharpe 0.72，最大回撤从未过滤版的 -19.42% 降至 -18.77%，更适合作为稳健默认配置。
...
The latest real-data run covers 2018-01-02 to 2026-07-29, with 30 ETFs, 54161 daily observations downloaded from Tushare.
...
|:--|--:|--:|--:|--:|--:|
| All-ETF EW | 10.86% | 16.50% | 0.66 | -18.83% | 2.419 |
| Pure Crowding | 22.00% | 34.43% | 0.64 | -17.38% | 5.495 |
| CSI 300 B&H | 1.39% | 19.71% | 0.07 | -45.10% | 1.126 |
| Mom-Crowding | 12.12% | 16.44% | 0.74 | -19.42% | 2.664 |
| Mom-Crowding+Trend | 9.20% | 12.81% | 0.72 | -18.77% | 2.126 |
| Pure 5D Mom | 8.07% | 16.92% | 0.48 | -20.81% | 1.945 |
...
- The unfiltered penalized momentum strategy earns 12.12% annualized with a 0.74 Sharpe, outperforming pure 5-day momentum and CSI 300 ETF buy-and-hold.
- The MA200 trend filter lowers annual return to 9.20%, but reduces max drawdown from -19.42% to -18.77%, making it the more conservative default.
