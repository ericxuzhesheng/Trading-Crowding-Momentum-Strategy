...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Period-2018-2026%20%7C%2055061%20obs-4caf50?style=for-the-badge&labelColor=4a4f59" alt="Period">
...
本次前复权数据运行覆盖 2018-01-02 至 2026-09-09，配置中共有 30 只场内基金，各标的按可用历史进入，合计 55061 条日频记录。
...
|:---|---:|---:|---:|---:|---:|
| 全配置资产等权参照 | 8.49% | 12.55% | 0.74 | -15.95% | 2.029 |
| 复合拥挤度得分对照 | 13.52% | 14.43% | 0.98 | -15.82% | 3.008 |
| 沪深300 ETF 买入持有 | 3.19% | 19.60% | 0.26 | -42.16% | 1.313 |
| 凸优化动量 - 拥挤度 | 14.03% | 12.11% | 1.19 | -11.54% | 3.128 |
| 凸优化动量 - 拥挤度 + 趋势过滤 | 9.48% | 10.80% | 0.92 | -13.12% | 2.196 |
| 动量 - 拥挤度 top30 上限等权 | 10.25% | 14.38% | 0.78 | -16.76% | 2.334 |
| 动量 - 拥挤度 top30 上限等权 + 趋势过滤 | 7.84% | 12.76% | 0.68 | -19.23% | 1.927 |
| 5 日动量对照 | 6.01% | 14.99% | 0.48 | -19.09% | 1.660 |
...
|---:|:---|---:|---:|---:|---:|---:|
| 0 bps | 情景 | 14.74% | 12.11% | 1.239 | -11.36% | 3.301 |
| 1 bps | 情景 | 14.50% | 12.11% | 1.221 | -11.42% | 3.242 |
| 2 bps | 情景 | 14.27% | 12.11% | 1.204 | -11.48% | 3.184 |
| 3 bps | 基准 | 14.03% | 12.11% | 1.186 | -11.54% | 3.128 |
| 5 bps | 情景 | 13.56% | 12.11% | 1.151 | -11.67% | 3.018 |
| 10 bps | 情景 | 12.40% | 12.10% | 1.063 | -11.98% | 2.759 |
...
The latest forward-adjusted run covers 2018-01-02 to 2026-09-09 and contains 55061 daily observations across 30 configured listed funds over their available histories.
...
|:---|---:|---:|---:|---:|---:|
| Configured-Universe EW Reference | 8.49% | 12.55% | 0.74 | -15.95% | 2.029 |
| Composite Crowding-Score Control | 13.52% | 14.43% | 0.98 | -15.82% | 3.008 |
| CSI 300 Buy & Hold | 3.19% | 19.60% | 0.26 | -42.16% | 1.313 |
| Convex Mom-Crowding | 14.03% | 12.11% | 1.19 | -11.54% | 3.128 |
| Convex Mom-Crowding + Trend | 9.48% | 10.80% | 0.92 | -13.12% | 2.196 |
| Capped Top-30% Mom-Crowding | 10.25% | 14.38% | 0.78 | -16.76% | 2.334 |
| Capped Top-30% Mom-Crowding + Trend | 7.84% | 12.76% | 0.68 | -19.23% | 1.927 |
| 5D Momentum Control | 6.01% | 14.99% | 0.48 | -19.09% | 1.660 |
