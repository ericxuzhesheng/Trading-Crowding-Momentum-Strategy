...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Period-2018-2026%20%7C%2055031%20obs-4caf50?style=for-the-badge&labelColor=4a4f59" alt="Period">
...
本次前复权数据运行覆盖 2018-01-02 至 2026-09-08，配置中共有 30 只场内基金，各标的按可用历史进入，合计 55031 条日频记录。
...
|:---|---:|---:|---:|---:|---:|
| 全配置资产等权参照 | 8.48% | 12.56% | 0.74 | -15.95% | 2.027 |
| 复合拥挤度得分对照 | 13.48% | 14.43% | 0.98 | -15.82% | 2.999 |
| 沪深300 ETF 买入持有 | 3.16% | 19.61% | 0.26 | -42.16% | 1.310 |
| 凸优化动量 - 拥挤度 | 14.06% | 12.11% | 1.19 | -11.54% | 3.132 |
| 凸优化动量 - 拥挤度 + 趋势过滤 | 9.47% | 10.80% | 0.92 | -13.12% | 2.194 |
| 动量 - 拥挤度 top30 上限等权 | 10.24% | 14.39% | 0.78 | -16.76% | 2.332 |
| 动量 - 拥挤度 top30 上限等权 + 趋势过滤 | 7.84% | 12.76% | 0.68 | -19.23% | 1.926 |
| 5 日动量对照 | 6.00% | 14.99% | 0.48 | -19.09% | 1.659 |
...
- 主实验「凸优化动量 - 拥挤度」在全样本记录年化 14.06%、标准 Sharpe 1.19、最大回撤 -11.54%，周均 L1 换手为 0.404。
- 在相同信号定义下，旧 top30% 上限等权配置的 Sharpe 为 0.78、最大回撤为 -16.76%；凸优化配置对应 1.19 和 -11.54%。两种配置的资产纳入、持仓上限和实际总暴露均有差异，因此这里只报告观察到的比较。
...
|---:|:---|---:|---:|---:|---:|---:|
| 0 bps | 情景 | 14.76% | 12.12% | 1.241 | -11.36% | 3.306 |
| 1 bps | 情景 | 14.53% | 12.11% | 1.223 | -11.42% | 3.247 |
| 2 bps | 情景 | 14.29% | 12.11% | 1.206 | -11.48% | 3.189 |
| 3 bps | 基准 | 14.06% | 12.11% | 1.188 | -11.54% | 3.132 |
| 5 bps | 情景 | 13.59% | 12.11% | 1.153 | -11.67% | 3.022 |
| 10 bps | 情景 | 12.42% | 12.10% | 1.065 | -11.98% | 2.763 |
...
The latest forward-adjusted run covers 2018-01-02 to 2026-09-08 and contains 55031 daily observations across 30 configured listed funds over their available histories.
...
|:---|---:|---:|---:|---:|---:|
| Configured-Universe EW Reference | 8.48% | 12.56% | 0.74 | -15.95% | 2.027 |
| Composite Crowding-Score Control | 13.48% | 14.43% | 0.98 | -15.82% | 2.999 |
| CSI 300 Buy & Hold | 3.16% | 19.61% | 0.26 | -42.16% | 1.310 |
| Convex Mom-Crowding | 14.06% | 12.11% | 1.19 | -11.54% | 3.132 |
| Convex Mom-Crowding + Trend | 9.47% | 10.80% | 0.92 | -13.12% | 2.194 |
| Capped Top-30% Mom-Crowding | 10.24% | 14.39% | 0.78 | -16.76% | 2.332 |
| Capped Top-30% Mom-Crowding + Trend | 7.84% | 12.76% | 0.68 | -19.23% | 1.926 |
| 5D Momentum Control | 6.00% | 14.99% | 0.48 | -19.09% | 1.659 |
...
- The main Convex Mom-Crowding experiment records 14.06% annualized return, a standard Sharpe of 1.19, -11.54% max drawdown, and 0.404 average weekly L1 turnover over the full sample.
- Under the same signal definition, the legacy capped top-30% configuration records Sharpe of 0.78 and max drawdown of -16.76%; the convex configuration records 1.19 and -11.54%. Eligible assets, position caps, and resulting exposure also differ, so the comparison does not isolate a causal effect.
